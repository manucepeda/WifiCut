"""
Module for performing OS fingerprinting using scapy and pyp0f.
"""
...
def perform_mtu_fingerprinting():
    """
    Perform MTU fingerprinting using scapy and pyp0f.

    Returns:
        MTUResult: Result of the MTU fingerprinting.
    """
...
def perform_tcp_fingerprinting():
    """
    Perform TCP fingerprinting using scapy and pyp0f.

    Returns:
        TCPResult: Result of the TCP fingerprinting.
    """
...
def perform_http_fingerprinting():
    """
    Perform HTTP fingerprinting using scapy and pyp0f.

    Returns:
        HTTPResult: Result of the HTTP fingerprinting.
    """
